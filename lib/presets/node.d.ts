...
export declare function SuperJSONFilePreset<Data>(filename: PathLike, defaultData: Data): Promise<Low<Data>>;
export declare function SuperJSONFileSyncPreset<Data>(filename: PathLike, defaultData: Data): LowSync<Data>;
